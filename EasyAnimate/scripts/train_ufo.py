...
from easyanimate.data.dataset_image_video import (ImageVideoSampler,
                                                  get_random_mask)
from easyanimate.data.dataset_static_video import StaticVideoDataset
...
def main():
    ...
    # Get the dataset - using StaticVideoDataset for static video generation
